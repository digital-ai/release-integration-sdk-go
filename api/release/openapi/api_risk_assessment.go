...
func (r ApiGetAssessmentRequest) Execute() (*RiskAssessment, *http.Response, error) {
	return r.ApiService.GetAssessmentExecute(r)
}
...
func (a *RiskAssessmentApiService) GetAssessmentExecute(r ApiGetAssessmentRequest) (*RiskAssessment, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/risks/assessments/{riskAssessmentId}"
	localVarPath = strings.Replace(localVarPath, "{"+"riskAssessmentId"+"}", url.PathEscape(parameterValueToString(r.riskAssessmentId, "riskAssessmentId")), -1)
