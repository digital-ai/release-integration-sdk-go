...
// checks if the UserInputTask type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UserInputTask{}
...
func (v NullableUserInputTask) Get() *UserInputTask {
	return v.value
}
...
func NewNullableUserInputTask(val *UserInputTask) *NullableUserInputTask {
	return &NullableUserInputTask{value: val, isSet: true}
}
